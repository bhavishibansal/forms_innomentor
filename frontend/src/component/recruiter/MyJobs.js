            ...
            <Grid item container direction="row" xs={9}>
              ...
              >
                <Grid item>
                  <Checkbox
                    name="dob"
                    checked={searchOptions.sort.dob.status}
                    onChange={(event) =>
                      setSearchOptions({
                        ...searchOptions,
                        sort: {
                ...
                <Grid item>
                  <IconButton
                    disabled={!searchOptions.sort.dob.status}
                    onClick={() => {
                      setSearchOptions({
                        ...searchOptions,
                        sort: {
                          ...
                          dob: {
                            ...searchOptions.sort.dob,
                            desc: !searchOptions.sort.dob.desc,
                          },
                        },
                      });
                    }}
                  >
                    {searchOptions.sort.dob.desc ? (
                      <ArrowDownwardIcon />
                    ) : (
                      <ArrowUpwardIcon />
                    )}
...
const MyJobs = (props) => {
  ...
  const getData = () => {
    ...
    if (searchOptions.dob != "0") {
      searchParams = [...searchParams, `dob=${searchOptions.dob}`];
    }
